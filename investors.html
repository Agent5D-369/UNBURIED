...
<head>
  ...
  <script type="application/ld+json">{
    ...
    "logo": "https://YOURDOMAIN.com/assets/icons/favicon.svg",
  ...
  <script type="application/ld+json">{
    ...
    "potentialAction": {
      ...
      "target": "https://YOURDOMAIN.com/index.html#waitlist",
...
<section class="page-hero page-hero-tight">
  <div class="container page-hero-grid hero-grid-v007">
    <div class="hero-copy reveal">
      <span class="eyebrow">For investors and strategic partners</span>
      <h1 class="display-title display-title-page">Back the release infrastructure that lets important films circulate, earn, and compound.</h1>
      <p class="lead">UNBURIED is not another content bet. It is transaction-driven release infrastructure for direct viewing, screening rights, educational licensing, and creator-owned audience growth.</p>
      <div class="hero-actions">
        <a class="btn btn-primary" href="#investor-form">Request the Investor Brief</a>
        <a class="btn btn-secondary" href="#why-now">See the business model</a>
      </div>
      <div class="hero-proof-list compact"><span>Transaction revenue</span><span>Rights-driven commerce</span><span>Reusable network effects</span></div>
    </div>
    <div class="hero-visual reveal reveal-delay">
      <div class="proof-frame">
        <div class="proof-topbar"><span></span><span></span><span></span><strong>unburied.network / thesis / commerce / rights</strong></div>
        <div class="proof-stack">
          <div class="proof-card">
            <span class="proof-kicker">Revenue stack</span>
            <h3>View • Host • License</h3>
            <p>A single title can create rental revenue, screening revenue, educational revenue, and support revenue.</p>
            <div class="proof-pill-row"><span>Transaction-first</span><span>No ad dependence</span></div>
          </div>
          <div class="proof-card floating-card floating-card-a">
            <span class="proof-kicker">Network growth</span>
            <h3>Each release strengthens the next</h3>
            <p>Hosts, supporters, educators, and affiliates become reusable infrastructure instead of one-off traffic.</p>
          </div>
          <div class="proof-card floating-card floating-card-b">
            <span class="proof-kicker">Infrastructure thesis</span>
            <h3>Seller tooling for film</h3>
            <p>The category is cinema. The architecture is closer to commerce and rights software.</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="investor-form" class="section-waitlist">
  <div class="container waitlist-shell reveal">
    ...
    <div class="form-shell form-shell-strong">
      ...
      <form action="https://formspree.io/f/mkopazaq" method="POST" class="form-grid">
        ...
        <button class="btn btn-primary btn-block" type="submit">Request the Investor Brief</button>
      </form>
    </div>
  </div>
</section>
  ...
  <div class="mobile-cta-bar">
    <a href="index.html#waitlist" class="btn btn-primary btn-block">Join the Waitlist</a>
  </div>
  <footer class="site-footer">
    <div class="container footer-grid">
      <div>
        <div class="footer-brand">UNBURIED Screen Network</div>
      ...
      <div>
        <div class="footer-label">Why investors stay close</div>
        <p class="footer-note">Because this category will reward the partners who understand it early, before the first serious network effects and rights relationships become obvious to everyone else.</p>
      </div>
    </div>
  </footer>
